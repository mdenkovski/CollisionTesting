...
#include "CollisionTestingCharacter.generated.h"

UCLASS(config=Game)
class ACollisionTestingCharacter : public ACharacter, public ISignificanceManagerInterface
{
	GENERATED_BODY()
...
public:
	...
	//virtual float GetSignificanceByDistance(float distance) override;
